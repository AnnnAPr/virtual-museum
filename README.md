...
An interactive web application that allows users to explore the collection of the Metropolitan Museum of Art using their public API. The application is built using vanilla JavaScript and uses Vite as a development server.
